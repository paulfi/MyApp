...
function drawMap(){
  ...
  function stationPopup(e) {
    ...
    if (station) {
      ...
      popup.setContent(
        "<h6>Station Number: "+ station.properties.STATION_NUMBER + 
  ...
  var stationLyr = L.geoJSON(sdata, {
    pointToLayer: function(feature,latlng){
      label = String(feature.properties.STATION_NUMBER);// .bindTooltip can't use straight 'feature.properties.attribute'
